...
export default function Intro() {
  return (
    <section className='mb-28 max-w-[50rem] text-center sm:mb-0'>
        ...
        <p className='mb-10 mt-3 px-4 text-slate-750 text-[1rem] md:text-xl'>I translate business needs into aesthetic and intuitive data products.
            Currently helping with integration AI into ERP systems and exploring new ideas in open source enviroment.</p>
        ...
        <motion.div className='flex flex-col sm:flex-row items-center justify-center gap-2 px-4 text-md font-medium'
            ...
            <Link href="#contact" className='group bg-slate-900 text-white px-7 py-3 flex items-center gap-2 rounded-full outline-none focus:scale-110 hover:bg-slate-950 active:scale-105 transition'>Contact me <BsArrowRight className='opacity-80 group-hover:translate-x-1 transition'/></Link>
